        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
          <section className="glass-panel rounded-3xl p-8 text-foreground shadow-sm">
            <h1 className="text-3xl font-semibold sm:text-4xl">
              Discover <span className="bg-[linear-gradient(118deg,#f97316_0%,#fb923c_30%,#2563eb_100%)] bg-clip-text text-transparent drop-shadow-[0_6px_12px_rgba(37,99,235,0.35)]">Max Hacker Tech Club</span> student projects
            </h1>
